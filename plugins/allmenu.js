...
`.trimStart(),
  ...
  footer: '╰─── –',
  after: `ʏᴀᴇᴍɪᴋᴏ ᴀɪ ${global.version}`,
}
  try {
    let name = m.pushName || global.db.data.users[m.sender].name || ""
    ...
    let bjir = 'https://telegra.ph/file/7354275ae4eb39baf7e1e.jpg'
 ...
 conn.sendMessage(m.chat, {
      video: fs.readFileSync('./menuvid/yaemiko.mp4'),
            mimetype: 'video/mp4',
            fileLength: 334875937493,
            caption: Styles(text),
            gifPlayback: true,
            gifAttribution: 5,
            contextInfo: {
                externalAdReply: {
                    ...
                    title: 'ᴍ ᴇ ɴ ᴜ  ʙ ᴏ ᴛ  ʏ ᴀ ᴇ',
                    thumbnailUrl: 'https://telegra.ph/file/7354275ae4eb39baf7e1e.jpg',
 ...
 type: 'audioMessage',  
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'ʏᴀᴇᴍɪᴋᴏ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ', body: wm, sourceUrl: 'https://whatsapp.com/channel/0029VaF8RYn9WtC16ecZws0H', thumbnail: await (await fetch(bjir)).buffer(),}}  
  }) 
    } catch (e) {
...
handler.command = /^(allmenu|menuall|menunya|yae)$/i
