    ...
    message: {
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          body: proto.Message.InteractiveMessage.Body.create({
            text: "PENCET TOMBOL DI BAWAH INI UNTUK DOWNLOAD SCRIPT"
          }),
          ...
          nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
            buttons: [            
                                          {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"KLIK UNTUK DOWNLOAD\",\"url\":\"https://s.id/elaina_button\",\"merchant_url\":\"https://s.id/elaina_button\"}"
              }
           ],
          })
        })
