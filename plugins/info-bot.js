...
await conn.sendMessage(m.chat, {text: loadd[i], edit: key })}
  ...
  let mentionedJid = [m.sender]
    ...
    let sts = ` – *ɪɴғᴏ ʙᴏᴛ ʏᴀᴇᴍɪᴋᴏ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ*
...
await conn.sendMessage(m.chat, {
            ...
            contextInfo: {
                externalAdReply: {
                    ...
                    title: 'ɪ ɴ ғ ᴏ  ʏ ᴀ ᴇ  ᴍ ɪ ᴋ ᴏ',
                    thumbnailUrl: 'https://telegra.ph/file/101e484dddce02919fbc5.jpg',
...
seconds: 18,
fileLength: 18,
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'ʏᴀᴇ ᴍɪᴋᴏ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ', body: wm, sourceUrl: 'https://whatsapp.com/channel/0029VaJHq2XFSAsz4dtOTE0T', thumbnail: await (await fetch(thumb)).buffer(),}}  
  }) 
}
